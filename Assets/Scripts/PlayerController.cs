...
public class PlayerController : MonoBehaviour
{
    ...
    private Vector3 _camForward; // keep track of the camera forward movement
    private Vector3 _camRight; // keep track of camera right movement
    // creating movedirection variable so the program doesn't need to create/delete new ones every time
    ...
    private void CalculateMovement()
    {
     ...
     //nullify the Y axis for camera movement
     _camForward.y = 0;
     _camRight.y = 0;
     //normalize movement
